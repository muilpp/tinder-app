...
import com.tinderapp.model.apidata.BlocksDTO;
import com.tinderapp.model.adapter.BlocksRecyclerAdapter;
...
public class BlocksFragment extends Fragment {
    ...
    private static final String TAG = BlocksFragment.class.getName();
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        if (adapter == null)
                            adapter = new BlocksRecyclerAdapter(blockList, getActivity());
                        else {
